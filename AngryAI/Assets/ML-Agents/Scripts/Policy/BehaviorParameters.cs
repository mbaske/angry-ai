...
namespace MLAgents
{
    ...
    public class BehaviorParameters : MonoBehaviour
    {
        ...
        // m.baske: added "use baracuda" option
        [HideInInspector] [SerializeField] private bool m_UseBarracuda;
        ...
        public IPolicy GeneratePolicy(Func<float[]> heuristic)
        {
            ...
            if (!m_UseBarracuda && FindObjectOfType<Academy>().IsCommunicatorOn)
            {
